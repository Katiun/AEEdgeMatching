...
public class JUAE {
    ...
    public void test2(){
        ...
        Ficha[][] interiorHijos = new Ficha[14][14];
        ArrayList poblacionArray = new ArrayList(); 
        poblacionArray.add(new Individuo(esquinasHijo1, bordesHijo1, interiorHijos));
        poblacionArray.add(new Individuo(esquinasHijo1, bordesHijo2, interiorHijos));
        poblacionArray.add(new Individuo(esquinasHijo2, bordesHijo1, interiorHijos));
        poblacionArray.add(new Individuo(esquinasHijo2, bordesHijo2, interiorHijos));  
